...
export default async function authorize(
    ...
    if(request.subject && request.subject !== cds.context?.user?.id){
        return cds.context?.http?.res
            .status(403)
            .send("Authorization request subject does not match the authenticated user");
    }
                                        ...
                                        <div className="flex items-center justify-between">
                                            <div>
                                                ...
                                                {request.grant_management_action === "merge" && (
                                                    <div
                                                        className="mt-2 p-2 bg-blue-500/10 border border-blue-500/20 rounded">
                                            ...
                                            <div
                                                className="flex items-center space-x-2 px-3 py-1 rounded bg-yellow-500/20 text-yellow-400">
