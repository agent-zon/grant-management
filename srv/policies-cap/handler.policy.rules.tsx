...
function rulesSectionJsx(rules: PolicyRule[], version: string, resources: TargetOption[]) {
  return (
...
export async function ADD_RULE(this: any, req: cds.Request) {
  ...
  return sendHtml(req, renderToString(rulesSectionJsx(newRules, version, req.data.resources ?? [])));
}
...
export async function REMOVE_RULE(this: any, req: cds.Request) {
  ...
  return sendHtml(req, renderToString(rulesSectionJsx(rules, v, d.resources ?? [])));
}
...
export async function RULES(this: any, req: cds.Request) {
  ...
  return sendHtml(req, renderToString(rulesSectionJsx(rules, version, resources)));
}
