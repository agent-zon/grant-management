...
interface WorkloadsPageProps {
  ...
  onNavigateToChat: (workloadId: string) => void;
  onNavigateToConsent?: (workloadId: string) => void;
}

const WorkloadsPage: React.FC<WorkloadsPageProps> = ({ onConsentRequest, onNavigateToChat, onNavigateToConsent }) => {
  ...
  // Listen for consent approval (this would normally come from the consent system)
  useEffect(() => {
    ...
    <div className="space-y-6">
      ...
      <div className="bg-gray-800/50 backdrop-blur-sm rounded-xl border border-gray-700 p-6">
        <div className="flex items-center justify-between">
          <div>
            <h2 className="text-xl font-bold text-white">Workloads</h2>
            <p className="text-sm text-gray-400">Agent session management</p>
          </div>
        ...
        {workloads.map((workload) => (
          <div key={workload.id} className="bg-gray-800/50 backdrop-blur-sm rounded-xl border border-gray-700 p-4">
            <div className="flex items-center justify-between mb-3">
              ...
              {workload.type === 'chat' && (
                <button
                  onClick={() => onNavigateToChat(workload.id)}
