...
export function meta({ data }: Route.MetaArgs) {
  ...
  return [
    ...
    {
      name: "description",
      content: `Manage consent for ${grant?.scope || "permission"}`,
    },
  ];
}
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="max-w-4xl mx-auto space-y-6">
          ...
          <div className="bg-gray-800/50 backdrop-blur-sm rounded-xl border border-gray-700 p-6">
            <div className="flex items-center space-x-4 mb-6">
              <div
                className={`p-3 rounded-lg ${grant.granted ? "bg-green-500/20" : "bg-red-500/20"}`}
              >
              ...
              <div>
                ...
                <div className="flex items-center space-x-4 mt-2">
                  <div
                    className={`flex items-center space-x-2 px-2 py-1 rounded border ${getRiskColor(grant.riskLevel)}`}
                  >
                  ...
                  <span className="text-xs text-gray-400 capitalize">
                    {grant.category.replace("-", " ")} Category
                  </span>
                </div>
              </div>
            </div>
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-red-300 mt-1">
                      ...
                      Consider using time-limited grants for enhanced security.
                    </p>
                  </div>
                </div>
              </div>
          ...
          {/* Current Status */}
          <div
            className={`bg-gray-800/50 backdrop-blur-sm rounded-xl border border-gray-700 p-4 mb-6 ${
              grant.granted ? "border-green-500/30" : "border-red-500/30"
            }`}
          >
            <div
              className={`flex items-center justify-between ${
                grant.granted ? "text-green-400" : "text-red-400"
              }`}
            >
                      ...
                      <div className="flex items-center space-x-3 mb-4">
                        ...
                        <div>
                          <p className="text-sm text-green-300">
                            This permission is currently granted and active
                          </p>
                        </div>
                      </div>
                    )}
                                ...
                                : tool.includes("Delete")
                                  ...
                                  : tool.includes("Export")
                                    ...
                                    : tool.includes("Generate")
                                      ...
                                      : tool.includes("System")
                                        ? "Access system settings"
                                        : tool.includes("Config")
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6  bg-gray-900/50 backdrop-blur-sm   p-6 ">
                  ...
                  {grant.lastUsed && (
                    <div className="flex justify-between">
                      ...
                      <span className="text-xs text-white">
                        {new Date(grant.lastUsed).toLocaleString()}
                      </span>
                    </div>
                  )}
                  {grant.sessionId && (
              ...
              <div className="bg-gray-700/50 rounded-lg p-4">
                ...
                <div className="space-y-2">
                  ...
                  {!grant.granted && (
                    <div className="text-xs text-gray-400">Never granted</div>
                  )}
                </div>
              </div>
            </div>
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-400">
                    See all consent decisions and usage
                  </p>
                </div>
              </Link>
