...
import type { Route } from "./+types/grants.vault";
...
export function meta({}: Route.MetaArgs) {
  return [
    ...
    {
      name: "description",
      content: "Track all consent decisions and system events",
    },
  ];
}
...
function faker() {
  return [
    ...
    },
    {
      ...
      workloadId: "wl-001",
      message:
        "User granted consent for scopes: tools:read, data:export, tools:write, notifications:send",
      details: {
        scopes: [
          "tools:read",
          "data:export",
          ...
          <div className="flex items-center justify-between mb-4">
            <div>
              ...
              <p className="text-sm text-gray-400">
                Track all consent decisions and system events
              </p>
            </div>
          </div>
          ...
          <div className="max-h-96 overflow-y-auto">
            {entries.length === 0 ? (
              ...
              <div className="divide-y divide-gray-700">
                {entries.map((entry) => (
                  <RenderAuditEntry key={entry.id} {...entry} />
                ))}
              </div>
            )}
          </div>
