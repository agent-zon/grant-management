...
import sample.spring.security.migration.mapper.FileBasedXsuaaScope2AmsPolicyMapper;
import sample.spring.security.migration.mapper.ScopeMapperConfiguration;

@SpringBootTest
@AutoConfigureMockMvc
@ActiveProfiles("filebasedmapper")
@ExtendWith(XsuaaExtension.class)
public class FileBasedXsuaaScope2PolicyMapperTest {
