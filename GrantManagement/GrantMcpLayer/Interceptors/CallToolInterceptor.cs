...
{
    public static async ValueTask<CallToolResult> Intercept(RequestContext<CallToolRequestParams> context,
        ...
        Func<RequestContext<CallToolRequestParams>, CancellationToken, ValueTask<CallToolResult>> next)
    {
        ...
        await channelWriter.WriteAsync(new DeviceFlowAuthRequestedEvent
        {
            ...
            ConsentExpiration = now + TimeSpan.FromMinutes(
                toolPolicy.ExplicitConsentPolicy?.ConsentExpirationMinutes ?? 10)
